...
revoke all on function public.dx3rd_save_board(text, text, jsonb) from public;
grant execute on function public.dx3rd_load_board(text, text) to anon, authenticated;
grant execute on function public.dx3rd_save_board(text, text, jsonb) to anon, authenticated;
